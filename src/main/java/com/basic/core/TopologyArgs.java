...
public class TopologyArgs implements Serializable {
  ...
  private static final String TOPOLOGY_NAME = "Eunomia";
...
//    public int numGeneratorsS = 0;
  ...
  public int numPartitionsR = 20;

  @Option(name = "-pj", aliases = "--part-j", metaVar = "<num>",
    usage = "# partitions of relation R [def:4]")
  public int numJoiners = 22;
  ...
  @Option(name = "-root", metaVar = "<num>",
    usage = "# joiner trees [def:1]")
  public int root = 2;

  @Option(name = "-degree", metaVar = "<num>",
    usage = "# joiner tree degree [def:2]")
  public int degree = 3;
